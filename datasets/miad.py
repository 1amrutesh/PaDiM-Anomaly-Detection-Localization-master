...
CLASS_NAMES = ['catenary_dropper', 'electrical_insulator', 'metal_welding', 'nut_and_bolt',
               'photovoltaic_module', 'wind_turbine', 'witness_mark']

class MIADDataset(Dataset):
    def __init__(self, dataset_path, class_name='catenary_dropper', is_train=True,
                 resize=256, cropsize=224, mean=None, std=None):
